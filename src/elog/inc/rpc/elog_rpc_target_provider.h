...
class ELOG_API ELogRpcTargetProvider : public ELogTargetProvider {
public:
...
protected:
     ...
     * @return ELogTarget* The resulting message queue log target, or null of failed.
     */
    virtual ELogTarget* loadRpcTarget(const ELogConfigMapNode* logTargetCfg,
