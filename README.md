...
| ------------- | ------------- | ------------- |
| Multiple Platform Support | - Windows</br>- Linux</br>- MinGW</br>- WSL2 (experimental) | ELog supports several platforms and toolchains (MSVC++, gcc, clang). Future versions may support also MacOS. |
...
- Multiple platform support
    - **Linux, Windows, MinGW, WSL2 (experimental)**
- Intuitive API
